          ...
          {filteredSignals.map((sig) => {
            ...
            return (
              <div 
                ...
                style={{ 
                  ...
                  boxShadow: isSelected
                    ...
                    : '0 8px 30px rgba(127, 0, 255, 0.04)',
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.boxShadow = isSelected 
                    ? '0 0 25px rgba(191, 90, 242, 0.3)' 
                    : '0 12px 35px rgba(127, 0, 255, 0.12)';
                  e.currentTarget.style.transform = 'translateY(-4px)';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.borderColor = isSelected ? '#bf5af2' : 'rgba(127, 0, 255, 0.15)';
                  e.currentTarget.style.boxShadow = isSelected 
                    ? '0 0 20px rgba(191, 90, 242, 0.2)' 
                    : '0 8px 30px rgba(127, 0, 255, 0.04)';
              ...
              >
                ...
                {/* Visual Magic Gradient Background Glow Wrapper (clips glow to card's border radius while keeping card overflow visible for tooltips) */}
                <div style={{
                  position: 'absolute',
                  top: 0,
                  left: 0,
